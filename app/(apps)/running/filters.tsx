          ...
          >
            ...
            <FilterSection title="Distance" section="distance">
              ...
              <View
                style={[
                  ...
                  { opacity: filterOptions.distance.enabled ? 1 : 0.5 },
                ]}
              >
                <View style={styles.inputGroup}>
                  <Text
                    style={[styles.inputLabel, { color: colors.neutral[500] }]}
                  >
                    Min (km)
                  </Text>
                  <TextInput
                    ...
                    value={
                      filterOptions.distance.min !== null
                        ? String(filterOptions.distance.min)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
                ...
                <View style={styles.inputGroup}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.distance.max !== null
                        ? String(filterOptions.distance.max)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
            ...
            <FilterSection title="Durée" section="duration">
              ...
              <View
                style={[
                  styles.minMaxContainer,
                  { opacity: filterOptions.duration.enabled ? 1 : 0.5 },
                ]}
              >
                <View style={styles.inputGroup}>
                  <Text
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.duration.min !== null
                        ? String(filterOptions.duration.min)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
                ...
                <View style={styles.inputGroup}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.duration.max !== null
                        ? String(filterOptions.duration.max)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
            ...
            <FilterSection title="Allure" section="pace">
              ...
              <View
                style={[
                  styles.minMaxContainer,
                  { opacity: filterOptions.pace.enabled ? 1 : 0.5 },
                ]}
              >
                <View style={styles.inputGroup}>
                  <Text
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.pace.min !== null
                        ? String(filterOptions.pace.min)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
                ...
                <View style={styles.inputGroup}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.pace.max !== null
                        ? String(filterOptions.pace.max)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
            ...
            <FilterSection title="Dénivelé" section="elevation">
              ...
              <View
                style={[
                  styles.minMaxContainer,
                  { opacity: filterOptions.elevation.enabled ? 1 : 0.5 },
                ]}
              >
                <View style={styles.inputGroup}>
                  <Text
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.elevation.min !== null
                        ? String(filterOptions.elevation.min)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
                ...
                <View style={styles.inputGroup}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.elevation.max !== null
                        ? String(filterOptions.elevation.max)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
            ...
            <FilterSection title="Fréquence cardiaque" section="heartRate">
              ...
              <View
                style={[
                  styles.minMaxContainer,
                  { opacity: filterOptions.heartRate.enabled ? 1 : 0.5 },
                ]}
              >
                <View style={styles.inputGroup}>
                  <Text
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.heartRate.min !== null
                        ? String(filterOptions.heartRate.min)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
                ...
                <View style={styles.inputGroup}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={colors.neutral[400]}
                    value={
                      filterOptions.heartRate.max !== null
                        ? String(filterOptions.heartRate.max)
                        : ''
                    }
                    onChangeText={(text) =>
                      handleTextChange(
                  ...
                  (feeling) => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        {
                          borderColor: filterOptions.feeling.values.includes(
                            feeling
                          )
                    ...
                    >
                      ...
                      <Text
                        style={[
                          ...
                          {
                            color: filterOptions.feeling.values.includes(
                              feeling
                            )
                              ? getFeelingColor(feeling)
                              : colors.neutral[500],
              ...
              {filteredSessions.length === 0 ? (
                ...
                <View style={styles.resultsStats}>
                  <View style={styles.resultsStat}>
                    <Text
                      style={[styles.resultsStatValue, { color: colors.text }]}
                    >
                      {filteredSessions
                        .reduce(
            ...
            >
              ...
              <ScrollView style={styles.helpScrollView}>
                ...
                <View style={styles.helpSection}>
                  ...
                  <Text style={[styles.helpText, { color: colors.text }]}>
                    Filtrez vos séances entre deux dates spécifiques. Par
                    défaut, les 3 derniers mois sont affichés.
                  </Text>
                </View>
                ...
                <View style={styles.helpSection}>
                  ...
                  <Text style={[styles.helpText, { color: colors.text }]}>
                    Sélectionnez un ou plusieurs ressentis pour filtrer vos
                    séances.
                  </Text>
                </View>
                ...
                <View style={styles.helpSection}>
                  ...
                  <Text style={[styles.helpText, { color: colors.text }]}>
                    Le bouton d'exportation CSV vous permet de télécharger
                    toutes les données des séances filtrées. Ce fichier peut
                    être ouvert dans Excel ou tout autre tableur.
                  </Text>
                </View>
              </ScrollView>
